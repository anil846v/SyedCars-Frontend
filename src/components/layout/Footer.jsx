  ...
  return (
    <footer style={{ background: '#fff', fontFamily: 'inherit', borderTop: '2px solid #E85D04' }}>
      ...
      <div style={{ position: 'relative', overflow: 'hidden', minHeight: 480 }}>
        ...
        {/* Car image — large, right-aligned, bottom-anchored like Image 2 */}
        <img
          src="/footercar.png"
          alt=""
          style={{
        ...
        {/* Left fade — gentle, only covers text area */}
        <div style={{
        ...
        {/* Bottom fade — thin soft fade matching Image 2 */}
        <div style={{
        ...
        {/* Content */}
        <div style={{ position: 'relative', zIndex: 3, maxWidth: 1200, margin: '0 auto', padding: '56px 48px 48px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '300px 1fr 1fr 1fr', gap: 40 }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 6 }}>
                ...
                <div style={{ borderLeft: '2px solid #ddd', paddingLeft: 14 }}>
                  <div style={{ fontSize: '2.1rem', fontWeight: 800, color: '#111', lineHeight: 1.05, letterSpacing: '-0.02em' }}>
                    Syed <span style={{ color: '#E85D04' }}>Cars</span>
                  </div>
                  <div style={{ fontSize: '0.6rem', letterSpacing: '0.2em', color: '#aaa', fontWeight: 700, textTransform: 'uppercase', marginTop: 5 }}>
                    Prestigious Car Marketplace
                  </div>
                </div>
              </div>

              <p style={{ fontSize: '0.95rem', color: '#555', lineHeight: 1.8, margin: '18px 0 28px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                {[
                  { href: 'tel:+916300365539', label: 'SALES', text: '+91 63003 65539', icon: 'M6.6 10.8c1.4 2.8 3.8 5.1 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.1.4 2.3.6 3.6.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1-9.4 0-17-7.6-17-17 0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.3.2 2.5.6 3.6.1.3 0 .7-.2 1L6.6 10.8z' },
                  ...
                  <a key={text} href={href} style={{ display: 'flex', alignItems: 'center', gap: 14, textDecoration: 'none' }}>
                    ...
                    <div>
                      <div style={{ fontSize: '0.65rem', fontWeight: 800, letterSpacing: '0.15em', color: '#E85D04', textTransform: 'uppercase' }}>{label}</div>
            ...
            <div style={{ paddingTop: 4 }}>
              <h4 style={{ fontSize: '0.78rem', fontWeight: 800, letterSpacing: '0.16em', textTransform: 'uppercase', color: '#E85D04', margin: '0 0 12px' }}>Browse</h4>
              <div style={{ width: 32, height: 3, background: '#E85D04', borderRadius: 2, marginBottom: 24 }} />
              <nav style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
                {[['All Cars', '/cars'], ['Petrol Cars', '/cars?fuel=Petrol'], ['Diesel Cars', '/cars?fuel=Diesel'], ['Hybrid / EV', '/cars?fuel=Hybrid']].map(([label, href]) => (
            ...
            {/* ── Company col ── */}
            <div style={{ paddingTop: 4 }}>
              <h4 style={{ fontSize: '0.78rem', fontWeight: 800, letterSpacing: '0.16em', textTransform: 'uppercase', color: '#E85D04', margin: '0 0 12px' }}>Company</h4>
              <div style={{ width: 32, height: 3, background: '#E85D04', borderRadius: 2, marginBottom: 24 }} />
              <nav style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
                {[['About Us', '/about'], ['Contact', '/contact'], ['List Your Car', '/contact']].map(([label, href]) => (
                  <Link key={label} to={href} style={{ display: 'flex', alignItems: 'center', gap: 10, fontSize: '0.97rem', color: '#333', textDecoration: 'none', fontWeight: 500 }}>
                    <svg width="8" height="13" viewBox="0 0 8 12" fill="none"><path d="M1 1l5 5-5 5" stroke="#E85D04" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                    {label}
                  </Link>
            ...
            {/* ── Legal col ── */}
            <div style={{ paddingTop: 4 }}>
              <h4 style={{ fontSize: '0.78rem', fontWeight: 800, letterSpacing: '0.16em', textTransform: 'uppercase', color: '#E85D04', margin: '0 0 12px' }}>Legal</h4>
              <div style={{ width: 32, height: 3, background: '#E85D04', borderRadius: 2, marginBottom: 24 }} />
              <nav style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
      ...
      <div style={{ borderTop: '2.5px solid #E85D04', background: '#fff' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '20px 48px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 24 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '0.82rem', color: '#888', margin: 0, display: 'flex', alignItems: 'center', gap: 5, marginTop: 2 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            {[
              ...
              { href: 'https://facebook.com', label: 'Facebook', path: 'M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.323-.593 1.323-1.325v-21.35c0-.732-.593-1.325-1.325-1.325z' },
            ].map(({ href, label, path }) => (

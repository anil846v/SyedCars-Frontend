    ...
    <div style={{ fontFamily: 'Inter, system-ui, sans-serif', background: '#fff', minHeight: '100vh' }}>
      ...
      <div style={{
        ...
        <div style={{ zIndex: 1, maxWidth: 480 }}>
          <p style={{
            color: '#E8631A', fontWeight: 700, fontSize: 11,
            letterSpacing: '0.14em', textTransform: 'uppercase',
            margin: '0 0 12px 0', display: 'flex', alignItems: 'center', gap: 10,
          }}>
            Get in Touch
            <span style={{ display: 'inline-block', width: 36, height: 2, background: '#E8631A', borderRadius: 2 }} />
          </p>
          <h1 style={{
          ...
          <div style={{ width: 44, height: 4, background: '#E8631A', borderRadius: 2, margin: '0 0 20px 0' }} />
          <p style={{ color: '#6B5E52', fontSize: 15, lineHeight: 1.75, margin: 0 }}>
      ...
      <div style={{ padding: '40px 64px 60px', display: 'flex', gap: 24, alignItems: 'flex-start' }}>
        ...
        <div style={{
          ...
          <button
            ...
            disabled={sending}
            style={{
              width: '100%', background: sending ? '#fdba74' : '#E8631A',
            ...
            onMouseLeave={e => { if (!sending) e.currentTarget.style.background = '#E8631A'; }}
          >
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: 20, fontWeight: 700, color: '#111', margin: '0 0 4px 0' }}>Get in Touch</h2>
          <div style={{ width: 40, height: 3, background: '#E8631A', borderRadius: 2, marginBottom: 16 }} />
          <p style={{ fontSize: 14, color: '#151515', lineHeight: 1.6, marginBottom: 28 }}>
          ...
          {[
            {
              icon: (
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#E8631A" strokeWidth="1.8">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2A19.79 19.79 0 0 1 11.39 19 19.5 19.5 0 0 1 5 12.61 19.79 19.79 0 0 1 2.12 4.18 2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
                </svg>
              ),
              label: 'Phone',
              lines: ['9177565639', 'Mon – Sat, 9:00 AM – 6:00 PM'],
            },
            {
              icon: (
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#E8631A" strokeWidth="1.8">
            ...
            <div key={label} style={{ display: 'flex', gap: 14, marginBottom: 22 }}>
              <div style={{
                ...
                background: '#FFF2EC', flexShrink: 0,
